...
def graph_3_corps(t_i, t_f, N):
    ...
    #ligne_A, = ax.plot(r_Ai, 'b-')
    #ligne_B, = ax.plot(r_Bi, 'g-')
    #ligne_C, = ax.plot(r_Ci, 'r-')
    ...
    #anim_ligne_A = lambda i: ligne_A.set_data(data_ligne_A.append(mouton["A"][i]))
    #anim_ligne_B = lambda i: ligne_B.set_data(data_ligne_B.append(mouton["B"][i]))
    #anim_ligne_C = lambda i: ligne_C.set_data(data_ligne_C.append(mouton["C"][i]))
